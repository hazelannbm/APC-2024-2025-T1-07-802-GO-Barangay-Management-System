...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class="form-container">
        ...
        <form action="{{ route('submit-indigency-certificate') }}" method="POST" enctype="multipart/form-data">
            ...
            <input id="reference_number" type="text" value="{{ uniqid('BRGY-') }}" readonly>
            ...
            <label for="proof_of_income">Proof of Income/No Income (Upload)</label>
            <input id="proof_of_income" type="file" name="proof_of_income" accept="image/*,application/pdf">

            <label for="valid_id">Valid ID (Upload)</label>
            <input id="valid_id" type="file" name="valid_id" accept="image/*" required>

            <label for="barangay_clearance">Barangay Clearance (Upload)</label>
            <input id="barangay_clearance" type="file" name="barangay_clearance" accept="image/*,application/pdf">
