...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .text-section {
                background-image: url("{{ asset('news/sample-news-2-1.png') }}"); /* Replace with the path to your background image */
...
<div class="text-section">
        <h1 align="center">Storytelling Session Inspires Young<br>Minds in Local Outreach Program</h1>
        ...
        <div style="flex: 0 0 75%; background-color:rgb(255, 255, 255); padding: 24px; border-radius: 8px; box-shadow: 0 4px 6px rgba(255, 255, 255, 0);">
            <article>
                <p class="text-gray-700 leading-relaxed mb-6">
                    In a heartwarming effort to bring the joys of reading to the community, volunteers recently hosted an educational storytelling session as part of a local outreach program. Held in a vibrant outdoor setting, the event was designed to spark creativity and cultivate a lifelong love for learning among children.
                </p>
                <p class="text-gray-700 leading-relaxed">
                    The program, organized by dedicated volunteers, transformed a public park into an engaging learning space. Brightly colored mats and cheerful decorations set the stage, while children gathered with eager eyes and curious minds, ready to embark on literary adventures.
                </p>
                <p class="text-gray-700 leading-relaxed">
                Seasoned storytellers took turns narrating captivating tales, ranging from classic folklore to contemporary children’s literature. With expressive voices, animated gestures, and visual props, the volunteers brought the stories to life, leaving their young audience enchanted. "It’s amazing to see how a simple story can light up their faces," said volunteer storyteller Maria Cruz. "Moments like these remind us why fostering a love for reading is so important."
                </p>
                <p class="text-gray-700 leading-relaxed">
                To encourage participation, children were invited to share their thoughts, act out parts of the story, and even suggest alternative endings. This interactive approach not only made the session enjoyable but also helped enhance the children’s comprehension and critical thinking skills.
                </p>
                <p class="text-gray-700 leading-relaxed">
                Parents in attendance praised the initiative for providing both entertainment and education in a single package. "It’s refreshing to see activities like this in the community. It’s a great way for kids to learn outside the classroom," shared one parent.
                </p>
                <p class="text-gray-700 leading-relaxed">
                At the end of the session, each child received a small gift: a storybook to take home. The gesture aimed to ensure that the enthusiasm for reading continued beyond the event.
                </p>
                <p class="text-gray-700 leading-relaxed">
                The outreach program’s organizers expressed their hopes of making the storytelling session a recurring event. "Our goal is to nurture curious, confident readers who are eager to explore the world of knowledge," said program leader Ana Reyes.
                </p>
                <p class="text-gray-700 leading-relaxed">
                With its combination of creativity, education, and community spirit, the storytelling session was a resounding success, leaving young hearts inspired and ready for more adventures in the world of books.
                </p>
            </article>
        </div>
