...
@section('admin-content')
    <div class="container">
        <div class="page-header">
            ...
            <a href="{{ route('admin.residents.create') }}" class="btn btn-primary">Add New Resident</a>
        </div>
                ...
                <tbody>
                    @forelse ($residents as $resident)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.residents.edit', $resident) }}" class="btn btn-sm btn-primary">Edit</a>
