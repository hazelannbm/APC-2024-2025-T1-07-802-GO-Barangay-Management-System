            ...
            <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                ...
                <header class="header-grid">
                    ...
                    <nav class="left-section flex space-x-4">
                        ...
                        <a href="#news" class="rounded-md px-3 py-2 text-white ring-1 ring-transparent transition hover:text-white/70 focus:outline-none focus-visible:ring-[#FF2D20]">
                            News
                        </a>                      
...
<body>
    ...
    <div class="content">
        <img src="{{ asset('news/sample-news-2.png') }}" alt="Health Center">
        <h1><strong>
        Storytelling Session Inspires Young Minds in Local Outreach Program</strong></h1>
        <p>In a heartwarming effort to bring the joys of reading to the community, volunteers recently hosted an educational storytelling session as part of a local outreach program. Held in a vibrant outdoor setting, the event was designed to spark creativity and cultivate a lifelong love for learning among children.</p>
        <p>The program, organized by dedicated volunteers, transformed a public park into an engaging learning space. Brightly colored mats and cheerful decorations set the stage, while children gathered with eager eyes and curious minds, ready to embark on literary adventures.</p>
        <p>Seasoned storytellers took turns narrating captivating tales, ranging from classic folklore to contemporary children’s literature. With expressive voices, animated gestures, and visual props, the volunteers brought the stories to life, leaving their young audience enchanted. "It’s amazing to see how a simple story can light up their faces," said volunteer storyteller Maria Cruz. "Moments like these remind us why fostering a love for reading is so important."</p>
        <p>To encourage participation, children were invited to share their thoughts, act out parts of the story, and even suggest alternative endings. This interactive approach not only made the session enjoyable but also helped enhance the children’s comprehension and critical thinking skills.</p>
        <p>Parents in attendance praised the initiative for providing both entertainment and education in a single package. "It’s refreshing to see activities like this in the community. It’s a great way for kids to learn outside the classroom," shared one parent.</p>
        <p>At the end of the session, each child received a small gift: a storybook to take home. The gesture aimed to ensure that the enthusiasm for reading continued beyond the event.</p>
        <p>The outreach program’s organizers expressed their hopes of making the storytelling session a recurring event. "Our goal is to nurture curious, confident readers who are eager to explore the world of knowledge," said program leader Ana Reyes.</p>
        <p>With its combination of creativity, education, and community spirit, the storytelling session was a resounding success, leaving young hearts inspired and ready for more adventures in the world of books.</p>
    </div>
